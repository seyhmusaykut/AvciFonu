<%@ Page Title="" Language="C#" MasterPageFile="~/sablonum.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="seyhmusaykut1747.login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table cellpadding="0" cellspacing="0" class="style3">
        ...
        <tr>
            <td align="center" class="loginss" colspan="2" height="50">Üye Ol</td>
        </tr>
        <tr>
            <td colspan="2" class="loginyazi">Adınız:<br />
                <asp:TextBox ID="adi" runat="server" CssClass="logintxtbx"></asp:TextBox><br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ErrorMessage="Adınızı Giriniz" ControlToValidate="adi"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="loginyazi">Soyadınız:<br />
                <asp:TextBox ID="sadi" runat="server" CssClass="logintxtbx"></asp:TextBox><br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ErrorMessage="Soyadınızı Giriniz" ControlToValidate="sadi"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="loginyazi">Kullanıcı Adınız:<br />
                <asp:TextBox ID="kadi" runat="server" CssClass="logintxtbx"></asp:TextBox><br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ErrorMessage="Kullanıcı Adınızı Giriniz" ControlToValidate="kadi"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="loginyazi">E-Postanız:<br />
                <asp:TextBox ID="epostam" runat="server" CssClass="logintxtbx"></asp:TextBox>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                    ControlToValidate="epostam" ErrorMessage="E-Postanızı Giriniz"></asp:RequiredFieldValidator>
                <br />
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ErrorMessage="aa23@aa.bb" ControlToValidate="epostam" 
                    ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="loginyazi">Parola:<br />
                <asp:TextBox ID="sifre" runat="server" TextMode="Password" CssClass="logintxtbx"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="loginyazi">Parola Tekrar:<br />
                <asp:TextBox ID="sifre2" runat="server" TextMode="Password" CssClass="logintxtbx"></asp:TextBox><br />
                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                    ErrorMessage="Şifreler Eşleşmiyor" ControlToCompare="sifre" 
                    ControlToValidate="sifre2"></asp:CompareValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="loginyazi">Memleketiniz:<br />
                <asp:DropDownList ID="Memleket" runat="server" CssClass="list">
        ...
        <tr>
            <td colspan="2" class="loginyazi">Doğum Tarihiniz:<br />
                <asp:DropDownList ID="DTarih" runat="server" CssClass="list">
         ...
         <tr>
            <td colspan="2" align="center"><br />
                <asp:Button ID="Button1" runat="server" Text="Üye Ol" CssClass="loginbutton" 
        ...
        <tr>
            <td>
                <asp:Panel ID="signup" runat="server" Visible="False">
                    <p class="p">
                        <img src="image/check.png" />  Üyelik İşleminiz Başarıyla Yapılmıştır.</p>
                </asp:Panel>
            </td>
        </tr>
    </table>
